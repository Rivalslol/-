loadstring(game:HttpGet("https://raw.githubusercontent.com/Rivalslol/scripts/main/noti.lua"))()
...
local function SIPZBJ_fake_script() -- FakeInternal.MainScript 
	...
	local Windows = {Console, Settings, ScriptHub}
	Dim.Visible = false
...
local function CLAL_fake_script() -- Settings.SettingsScript 
	...
	task.spawn(function()
		...
		script.Parent.Version.Text = string.format("%s | Vischeckk - Rival", shared.FakeInternal.Version)
	end)
end
...
local function NYMIRF_fake_script() -- ScriptHub.ScriptHubScript 
	...
	local function GetScript(file)
		...
		local url = string.format("https://raw.githubusercontent.com/Rivalslol/scripts/main/%s.lua", file)
	...
	local scripts = {
		...
		{
			Name = "Gato Hub",
			Script = GetScript("gatohub"),
			Author = "Gato",
			Description = "Best pet catchers script.",
			Image = GetImage("gatohub", "https://i.imgur.com/PITdD61.png")
		},
		{
			Name = "Gato Hub BETA",
			Script = GetScript("gatohubbeta"),
			Author = "Gato",
			Description = "Best pet catchers script.[BETA]",
			Image = GetImage("gatohubbeta", "https://i.imgur.com/PITdD61.png")
		},
		{
			Name = "Server Rejoin",
			Script = GetScript("rejoin"),
			Author = "Rival",
			Description = "Simple server rejoin script.",
			Image = GetImage("rejoin", "https://i.imgur.com/JPCYdYK.png")
		},
		{
			Name = "Simple Spy",
			Script = GetScript("SimpleSpy"),
			Author = "Gato",
			Description = "Script to catch remote fires.",
			Image = GetImage("SimpleSpy", "https://i.imgur.com/JPCYdYK.png")
		}
	}
